      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-6">
            ...
            <Link
              to="/contact"
              className="bg-pink-600 hover:bg-pink-500 text-white px-5 py-2.5 rounded-md font-bold text-sm transition-colors"
            >
              Contact Me
            </Link>
          </nav>
        ...
        <div className="lg:hidden absolute top-full left-0 right-0 bg-pink-950 border-t border-pink-800 p-4 shadow-xl">
          <div className="flex flex-col gap-4">
            ...
            <Link
              to="/contact"
              onClick={() => setMobileMenuOpen(false)}
              className="bg-pink-600 hover:bg-pink-500 text-white px-5 py-3 rounded-md font-bold text-center transition-colors w-full mt-2 inline-block"
            >
              Contact Me
            </Link>
          </div>
